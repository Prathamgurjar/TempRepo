const addEquform = () => {
  return (
    <div className="flex justify-center items-center min-h-screen bg-gradient-to-r from-[#a8e063] to-[#56ab2f] px-4 pt-20">
      ...
      <h2 className="text-2xl text-white ">Add Equipment</h2>
      <form action="">
        <div>
          ...
          className="w-full px-4 py-2 mb-4  bg-white text-black placeholder-black border-gray-500 focus:ring-2 focus:ring-green-500 outline-none rounded-lg"  />
        </div>
        ...
        <div>
          ...
          multiple
          placeholder="Enter name "
          className="w-full px-4 py-2  bg-white text-black placeholder-black border-gray-500 focus:ring-2 focus:ring-green-500 outline-none rounded-lg file-input-ghost" />
        </div>
        <button 
          type="submit" 
